...
ActiveRecord::Schema.define(version: 20160714034501) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "nationality"
    t.string "residence"
    t.integer "current_education_id"
    t.integer "looking_education_id"
    t.string "organization_name"
    t.string "organization_website"
    t.string "organization_opportunities"
